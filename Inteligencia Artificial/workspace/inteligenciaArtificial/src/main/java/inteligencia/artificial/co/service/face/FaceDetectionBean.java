...
//	 "{\"url\":\"https://okdiario.com/img/2019/09/10/michael-jackson-655x368.jpg\"}";
	...
	public String faceDetectionMethod(CriminalEntity criminalEntity) {
		...
		try {
			...
			// Request body.
			String foto = criminalEntity.getFoto();
			String url1 = "{\"url\":\"";
			String url2 = "\"}";
...
//			System.out.println(foto);
			...
			if (entity != null) {
				...
				if (jsonString.charAt(0) == '[') {
					...
					criminalEntity.setFoto(foto);
					criminalEntity.setFaceId(faceIdFinal);
...
//					return faceIdFinal;
		...
		Exception e) {
			...
			System.out.println("error al realizar el reconocimiento de imagen" + e.getMessage());
		}
		return criminalEntity.getFaceId();
